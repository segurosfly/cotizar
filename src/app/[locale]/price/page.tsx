          ...
          <div className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow">
            <div className={`${isScrolled ? 'p-4' : 'p-8'}`}>
              ...
              <div className={`flex items-center justify-between mb-4 ${isScrolled ? 'flex-row' : 'sm:flex-col sm:items-start'}`}>
                ...
                {isScrolled && (
                  <Link href="/get-started" className="bg-gray-800 text-white px-3 py-1 rounded-md text-sm font-medium hover:bg-gray-700 transition-colors ml-2" title="Obtener Plan Básico">
      ...
      <div className="container mx-auto px-6 md:px-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow">
            <div className="p-8">
              ...
              <div className="flex items-baseline mb-4">
                ...
                <span className="text-gray-500 ml-2">/ Por Viaje</span>
              </div>
              <p className="text-gray-600 mb-6">
                There are many variations of passages of Lorem Ipsum available, but the majority
              </p>
            ...
            <div className="px-8 pb-8">
              <Link href="/get-started" className="block w-full text-white text-center py-3 rounded-md font-medium hover:opacity-90 transition-colors" style={{ backgroundColor: '#123550' }}>
                Get You Free plan
              </Link>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow">
            ...
            <div className="px-8 pb-8">
              <Link href="/get-started" className="block w-full bg-gray-800 text-white text-center py-3 rounded-md font-medium hover:bg-gray-700 transition-colors">
                Get You Free plan
              </Link>
            </div>
          </div>
